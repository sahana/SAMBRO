...
'Editor': 'บรรณาธิการ',
'Editor - can access & make changes to any unprotected data': 'Editor - can access & make changes to any unprotected data',
'Education': 'การศึกษา',
...
'Links': 'การเชื่อมโยง',
'List': 'List',
'List %(site_label)s Status': 'สถานะของรายการ %(site_label)',
...
'Repositories': 'คลัง',
'Repository': 'กรุ',
'Repository Configuratio': 'Repository Configuration',
...
'SMS Outbound Gateways': 'SMS Outbound Gateways',
...
'SMTP to SMS Channels': 'SMTP to SMS Channels',
'Snapshot': 'ภาพรวม',
'Snow': 'หิมะ',
'Snow Fall': 'หิมะตก',
...
'The following %(new)s %(resource)s have been added': 'มีการเพิ่ม% (ใหม่) s% (ทรัพยากร) ต่อไปนี้',
'The following %(upd)s %(resource)s have been updated': 'อัพเดต% (upd) s% (ทรัพยากร) ต่อไปนี้แล้ว',
...
'Tropo Maintenance Officer': 'Tropo Maintenance Officer',
